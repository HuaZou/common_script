...
## 
## Normalization after filtering non-bacteria microbiome (norm TSS)
##    a. k__Archaea
##    a. k__Viruses
##    a. k__Eukaryota
##    a. Others
...
# Normalization after filtering non-bacteria microbiome (norm TSS) #
wgs_total_norm <- XMAS2::norm_tss(total_res$wgs)
filter_wgs_norm <- XMAS2::norm_tss(filter_wgs)
baseR6_wgs_norm <- XMAS2::norm_tss(baseR6_wgs)
...
## wgs norm
wgs_total_norm_name <- paste0(out, "/", name, "_BJ_", round_name, "_ps_total_norm.RDS")
wgs_filter_norm_name <- paste0(out, "/", name, "_BJ_", round_name, "_ps_filter_norm.RDS")
wgs_baseR6_norm_name <- paste0(out, "/", name, "_BJ_", round_name, "_ps_baseR6_norm.RDS")
...
## wgs norm
saveRDS(wgs_total_norm, wgs_total_norm_name, compress = TRUE)
saveRDS(filter_wgs_norm, wgs_filter_norm_name, compress = TRUE)
saveRDS(baseR6_wgs_norm, wgs_baseR6_norm_name, compress = TRUE)
